...
const char PROGMEM HELP_BACKUP_SPIFFS_CMD[] = "backupspiffs - copy SPIFFS to /spiffs on SD";
const char PROGMEM HELP_RESTORE_SPIFFS_CMD[] = "restorespiffs - restore SPIFFS from /spiffs on SD";
