...
const char PROGMEM HELP_PROTOCOL_INFO_CMD[] = "protocolinfo";
const char PROGMEM HELP_BACKUP_SPIFFS_CMD[] = "backupspiffs";
const char PROGMEM HELP_BACKUP_STATUS_CMD[] = "backupstatus";
const char PROGMEM HELP_RESTORE_SPIFFS_CMD[] = "restorespiffs";
