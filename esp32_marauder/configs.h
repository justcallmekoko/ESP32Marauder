#pragma once
  ...
  #elif defined(MARAUDER_ONX2432G028)
    #define HARDWARE_NAME "ONX2432G028"
  #else
 ...
 //// BOARD FEATURES
  ...
  #ifdef MARAUDER_ONX2432G028
    #define HAS_TOUCH
    //#define FLIPPER_ZERO_HAT
    //#define HAS_BATTERY
    #ifndef MARAUDER_ONX2432G028_NO_BT
      #define HAS_BT
    #endif
    //#define HAS_BUTTONS
    //#define HAS_NEOPIXEL_LED
  ...
  //// DISPLAY DEFINITIONS
    ...
    #if defined(MARAUDER_ONX2432G028)
      #define CHAN_PER_PAGE 7
      ...
      // ONX2432G028 uses a 2.8" ST7789 SPI panel with CST826 I2C capacitive touch.
      #define GRAPH_VERT_LIM TFT_HEIGHT/2 - 1
      ...
      #define ONX2432G028_I2C_SDA 8
      #define ONX2432G028_I2C_SCL 7
      #define ONX2432G028_CST826_ADDR 0x15
      #define ONX2432G028_CST826_DATA_REG 0x02
      #define ONX2432G028_PCF8574_ADDR 0x38
      #define ONX2432G028_PCF8574_LCD_RST_PIN 6
      #define ONX2432G028_PCF8574_SD_CS_PIN 7
      #define ONX2432G028_SD_CLK 11
      #define ONX2432G028_SD_CMD 10
      #define ONX2432G028_SD_D0 9
    #endif
  ...
  //// MENU DEFINITIONS
    ...
    // ONX2432G028 has no discrete buttons; use the full-screen touch menu geometry.
  ...
  //// BATTERY STUFF
    ...
    #ifdef MARAUDER_ONX2432G028
      #define I2C_SDA ONX2432G028_I2C_SDA
      #define I2C_SCL ONX2432G028_I2C_SCL
    #endif
