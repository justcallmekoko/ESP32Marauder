...
void WiFiScan::broadcastCustomBeacon(uint32_t current_time, AccessPoint custom_ssid, int scan_mode) {
  ...
  static const uint8_t post_quiet[] = {
    ...
    0x00, 0x00, 0x32, 0x04, 0x0c, 0x12, 0x18, 0x60,
    0x28, 0x06,             // Quiet element ID and payload length
    0x01, 0x05,             // Count 1, Period 5
    0x14, 0x00, 0x20, 0x00  // Duration 20 TU, Offset 32 TU (little-endian)
  };
