...
#ifdef HAS_C5_SD
  // Do not construct a second SPIClass on GPSPI. TFT_eSPI already owns FSPI
  // (USE_FSPI_PORT). SD attaches to that instance after tft.init().
  SDInterface sd_obj = SDInterface(nullptr, SD_CS);
#endif
