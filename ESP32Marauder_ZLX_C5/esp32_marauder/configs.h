...
#define MARAUDER_VERSION "v1.16.0"
 ...
 //// BOARD FEATURES
  ...
  //// DISPLAY DEFINITIONS
    ...
    #if defined(MARAUDER_V8) || defined(MARAUDER_ZLX_C5)
      #define CHAN_PER_PAGE 7
  ...
  //// BATTERY STUFF
    ...
    #elif defined(MARAUDER_ZLX_C5)
      // ADC battery on GPIO1, no fuel-gauge I2C
  ...
  //// STUPID CYD STUFF
      ...
      #define XPT2046_MOSI 5
      #define XPT2046_MISO 3
      #define XPT2046_CLK  4
      #define XPT2046_CS   23
      #define SD_MISO      2
      #define SD_MOSI      7
      #define SD_SCK       6
    #endif
