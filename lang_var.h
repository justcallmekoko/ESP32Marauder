...
PROGMEM const char text0_001[] = "Loading the SASQUACH";
PROGMEM const char text0_002[] = "Adding extra WAIFU and UWUs";
...
//Making tables
PROGMEM const char *text_table0[] = {text0_001,text0_002,text0_0,text0_1, text0_2, text0_3, text0_4, text0_5, text0_6, text0_7, text0_8};
